...
from dataset_combined import CombinedEmotionDataset
...
print("Training on: RAVDESS + TESS")

# -----------------------------
# DATASET
# -----------------------------
dataset = CombinedEmotionDataset(
    ravdess_path="data/RAVDESS",
    tess_path="data/TESS_processed",
    augment=False
)
...
with open(f"{RESULTS_DIR}/metrics.txt", "w") as f:
    f.write(f"Model: CNN+LSTM (RAVDESS + TESS)\n")
